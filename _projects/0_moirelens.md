...
- Develop AutoMoiré, an automatic calibration loop that continuously adjusts stimulus frequency and phase to maintain stable Moiré response across typical camera positions.
