    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/3_network_simulation/";
            },},{id: "projects-sketchgenie",
          title: 'SketchGenie',
          description: "AI-Driven AR Drawing Assistant",
          section: "Projects",handler: () => {
              window.location.href = "/projects/4_sketchgenie/";
            },},{id: "projects-bluetooth-controlled-robotics-vehicle",
          title: 'Bluetooth-Controlled Robotics Vehicle',
          description: "First Prize winner at SJTU Freshman Mechanical Innovation Competition",
          section: "Projects",handler: () => {
              window.location.href = "/projects/5_robotics_vehicle/";
            },},{id: "projects-telegram-chatbot-with-message-summarization",
